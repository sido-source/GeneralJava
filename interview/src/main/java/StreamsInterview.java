...
//            return Optional.of(s + " and that");
//        });
//        System.out.printf("Case 2 before - spy: %s%n", spy[0]); // 0
//        String result = before.orElse("nothing");
//        System.out.printf("Case 2 after - result: %s, spy: %s%n", result, spy[0]); // nothing, 0
//    }
//
//    // Case 3
//    public static void main(String[] args) {
...
//        });
//        System.out.printf("Case 3 before - spy: %s%n", spy[0]); // 1
//        String result = before.orElse("nothing");
//        System.out.printf("Case 3 after - result: %s, spy: %s%n", result, spy[0]); // nothing, 1
//    }
//
//    // Case 4
//    public static void main(String[] args) {
...
//                    return Optional.of(s + " and that");
//                });
//        System.out.printf("Case 4 before - spy: %s%n", spy[0]); // 0
//        String result = before.orElse("nothing");
//        System.out.printf("Case 4 after - result: %s, spy: %s%n", result, spy[0]); // 0, nothing
//    }
//
//    // Case 5
//    public static void main(String[] args) {
...
//                    return Optional.of(s + " and that");
//                });
//        System.out.printf("Case 5 before - spy: %s%n", spy[0]); // 1
//        String result = before.orElse("nothing");
//        System.out.printf("Case 5 after - result: %s, spy: %s%n", result, spy[0]); // this and that, 1
//    }
//
//    // Case 6
        ...
        System.out.printf("Case 6 before - spy: %s%n", spy[0]); // 2
        List<String> result = before.collect(Collectors.toList());
        System.out.printf("Case 6 after - result: %s, spy: %s%n", result, spy[0]); // Gasoline is fuel, Diesel is fuel, 2
    }
//
//    // Case 7
//    public static void main(String[] args) {
...
//                });
//        System.out.printf("Case 9 before - spy: %s%n", spy[0]); // 0
//        List<String> result = before.collect(Collectors.toList());
//        System.out.printf("Case 9 after - result: %s, spy: %s%n", result, spy[0]); // pineapple, is a fruit, mango, is a fruit, 2
//    }
    }
}
